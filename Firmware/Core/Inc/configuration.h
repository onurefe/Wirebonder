...
/* Z Motor Control ---------------------------------------------------------*/
#define ZMOTOR_CONTROLLER_MAX_NUM_OF_CALLBACKS 8

#define ZMOTOR_ZERO_VELOCITY_DUTY 0.5
#define ZMOTOR_SETTLING_TIME_WINDOW 10.0
...
#define ZMOTOR_CONTROLLER_MAX_DUTY 1.0 
#define ZMOTOR_CONTROLLER_MIN_DUTY 0.0
...
#define FORCE_COIL_DRIVER_SETTLING_TIME_WINDOW 5e-2
