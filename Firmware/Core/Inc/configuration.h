...
#define LVDT_MODULE_STROKE_MM                               10.0   /* TODO: calibrate */
...
#define DEBUG_MOTOR_VELOCITY_CONTROLLER_TELEMETRY_DEPTH     1024
#define DEBUG_FORCE_COIL_TELEMETRY_DEPTH                    1024

#define DEBUG_PLL_TELEMETRY_DEPTH                           1024
...
#define FORCE_COIL_MODULE_CONTROL_FREQUENCY                 250

#define FORCE_COIL_MODULE_V2I_CONVERSION_FACTOR             1.2804097311139564

#define FORCE_COIL_MODULE_PID_GAIN                          1.0
#define FORCE_COIL_MODULE_PID_INTEGRAL_TC                   0.01
#define FORCE_COIL_MODULE_PID_DERIVATIVE_TC                 0.0
#define FORCE_COIL_MODULE_PID_INPUT_FILTER_TC               0.001
...
#define DCMOTOR_VELOCITY_MODULE_CONTROL_FREQUENCY                    250

/* Tachometer AnalogChannel wiring (Robot-level; feeds the velocity loop). */
#define ZMOTOR_MODULE_TACHOMETER_V_TO_RPM                            1.0
...
#define DCMOTOR_VELOCITY_MODULE_PID_GAIN                             1.0
#define DCMOTOR_VELOCITY_MODULE_PID_INTEGRAL_TC                      0.1
#define DCMOTOR_VELOCITY_MODULE_PID_DERIVATIVE_TC                    0.
#define DCMOTOR_VELOCITY_MODULE_PID_FILTER_TC                        0.05
#define DCMOTOR_VELOCITY_MODULE_PID_OUTPUT_MIN                       -0.5
#define DCMOTOR_VELOCITY_MODULE_PID_OUTPUT_MAX                       0.5

/* DcMotorPositionControllerModule (middle loop: LVDT -> velocity setpoint) --*/
#define DCMOTOR_POSITION_MODULE_CONTROL_FREQUENCY                    250

#define DCMOTOR_POSITION_MODULE_PID_GAIN                             1.0
#define DCMOTOR_POSITION_MODULE_PID_INTEGRAL_TC                      0.1
#define DCMOTOR_POSITION_MODULE_PID_DERIVATIVE_TC                    0.
#define DCMOTOR_POSITION_MODULE_PID_FILTER_TC                        0.05
#define DCMOTOR_POSITION_MODULE_PID_OUTPUT_MIN                       -1.0
#define DCMOTOR_POSITION_MODULE_PID_OUTPUT_MAX                       1.0

/* DcRouterModule (trapezoid planner + move lifecycle for a DC-motor axis) ---*/
#define DCROUTER_MODULE_CONTROL_FREQUENCY                            250

#define DCROUTER_MODULE_SETTLING_TIME_WINDOW                         10.0

#define DCROUTER_MODULE_MAX_POSITION_ERROR                          1e-2
#define DCROUTER_MODULE_MAX_VELOCITY_ERROR                          1e-2
...
#define ROBOT_ZMOTOR_MAX_VELOCITY                           0.05
#define ROBOT_ZMOTOR_MAX_ACCELERATION                       0.05
