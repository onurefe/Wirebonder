...
/* Private defines -----------------------------------------------------------*/
#define TIM5_CLOCK_FREQ 90000000
#define ADC2_SAMPLING_FREQ 60000
#define DAC1_SAMPLING_FREQ 360000
#define ADC1_SAMPLING_FREQ 360000
#define DAC2_SAMPLING_FREQ 60000
#define STEPPER_ISR_FREQ 20000
#define TIM3_CLOCK_FREQ 90000000
#define TIM3_RELOAD_VALUE ((TIM3_CLOCK_FREQ/ADC2_SAMPLING_FREQ)-1)
#define TIM1_CLOCK_FREQ 180000000
#define TIM4_RELOAD_VALUE ((TIM4_CLOCK_FREQ/DAC1_SAMPLING_FREQ)-1)
#define TIM5_RELOAD_VALUE ((TIM5_CLOCK_FREQ/DAC2_SAMPLING_FREQ)-1)
#define TIM6_RELOAD_VALUE ((TIM6_CLOCK_FREQ/STEPPER_ISR_FREQ)-1)
#define TIM4_CLOCK_FREQ 90000000
#define TIM2_RELOAD_VALUE ((TIM2_CLOCK_FREQ/ADC1_SAMPLING_FREQ)-1)
#define TIM6_CLOCK_FREQ 90000000
#define TIM1_PWM_FREQ 30000
#define TIM2_CLOCK_FREQ 90000000
#define TIM1_RELOAD_VALUE ((TIM1_CLOCK_FREQ/TIM1_PWM_FREQ)-1)
#define TIM12_CLOCK_FREQ 90000000
#define TIM12_PWM_FREQ 20000
#define TIM12_RELOAD_VALUE ((TIM12_CLOCK_FREQ/TIM12_PWM_FREQ)-1)
...
#define DRIVES_SPOTLIGHT_PWM_Pin GPIO_PIN_6
#define DRIVES_SPOTLIGHT_PWM_GPIO_Port GPIOC
#define DRIVES_AREALIGHT_nPWM_Pin GPIO_PIN_7
