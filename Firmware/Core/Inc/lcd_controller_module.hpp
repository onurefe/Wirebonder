#ifndef LCD_CONTROLLER_MODULE_HPP
#define LCD_CONTROLLER_MODULE_HPP
...
//
// delayTimer must be registered with TimerExpireService before the process starts.
//
// Usage:
...
public:
    LcdControllerModule(Pca9538ExpanderChannel *expander, Timer *delayTimer);
...
#endif /* LCD_CONTROLLER_MODULE_HPP */
