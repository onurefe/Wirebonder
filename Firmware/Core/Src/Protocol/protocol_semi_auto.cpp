...
const BonderProtocol::Instruction SemiAutoBondingProtocol::s_protocol[] = {
    // ---- Phase 1: first bond ----
...
const BonderModule::Instruction *SemiAutoBondingProtocol::getProtocolPtr() const
{
    return s_protocol;
}

uint8_t SemiAutoBondingProtocol::getProtocolSize() const
{
