...
DirectPwmChannel BonderDebugEnvironment::m_clampPwmChannel(&htim12, TIM_CHANNEL_2);
PwmSolenoidChannel BonderDebugEnvironment::m_clampSolenoidChannel(
    &BonderDebugEnvironment::m_clampPwmChannel,
