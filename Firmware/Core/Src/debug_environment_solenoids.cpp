...
FastIO SolenoidsDebugEnvironment::m_clampHighPin(DRIVES_SOL3H_GPIO_Port, DRIVES_SOL3H_Pin, FALSE);
...
DirectSolenoidChannel SolenoidsDebugEnvironment::m_clampSolenoidChannel(
    &SolenoidsDebugEnvironment::m_clampHighPin,
    &SolenoidsDebugEnvironment::m_clampLowPin,
...
DirectSolenoidChannel *const SolenoidsDebugEnvironment::m_channels[kChannelCount] = {
